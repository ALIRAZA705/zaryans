...
const { default: EditVitalSign } = require("../views/patients/EditVitalSign");
...
var Patients = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/patients/Patients'));
  });
});


var VitalSigns = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/patients/VitalSigns'));
  });
});

var AddPatient = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/patients/AddPatient'));
  });
});

var EditPatient = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/patients/EditPatient'));
  });
});

var Physicians = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/physicians/Physicians'));
  });
});

var AddPhysician = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/physicians/AddPhysician'));
  });
});


var EditPhysician = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/physicians/EditPhysician'));
  });
}); //const TestCalendar = React.lazy(() => import('./CalendarApp'));


var Appointments = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/appointments/Appointments'));
  });
});
var Receptionists = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/receptionists/Receptionists'));
  });
});

var GuestMeeting = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/meetings/GuestMeeting'));
  });
});

var HostMeeting = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/meetings/HostMeeting'));
  });
});

var Permission = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/meetings/Permission'));
  });
});

var Histories = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/history/Histories'));
  });
});

var AddHistory = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/history/AddHistory'));
  });
});

var EditHistory = _react["default"].lazy(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('./views/history/EditHistory'));
  });
});
...
},
{
  ...
  path: '/meetings/GuestMeeting',
  name: 'Guest Meeting',
  component: GuestMeeting
}, {
  path: '/meetings/Permission',
  name: 'Host Meeting',
